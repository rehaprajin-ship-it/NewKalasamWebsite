...
export const seedProducts: Partial<Product>[] = [
  // ── Industrial Products ──────────────────────────────────────
  {
    ...
    purity: 'Technical Grade (≥96%)',
    appearance: 'White crystalline powder or granules',
    odor: 'Characteristic camphoraceous',
    meltingPoint: '175–179 °C',
    boilingPoint: '204–209 °C',
    density: '0.990–0.996 g/cm³',
  ...
  },
  {
    ...
    molecularFormula: 'C₁₀H₁₆O',
    molecularWeight: '152.23 g/mol',
    purity: '≥98% (Dextrorotatory)',
    odor: 'Characteristic camphoraceous, minty',
  ...
  },
  {
    ...
    purity: 'Technical Grade (≥95%)',
    appearance: 'White crystalline powder',
    odor: 'Mild camphoraceous, borneol-like',
    meltingPoint: '212 °C',
    boilingPoint: '214 °C',
    density: '1.011 g/cm³',
    solubility: 'Slightly soluble in water; soluble in ethanol, ether',
  ...
  },
  {
    ...
    casNumber: '8008-51-3',
    molecularFormula: 'Complex mixture (C₁₀H₁₆O major)',
    molecularWeight: '~152 g/mol (main component)',
    purity: 'Natural Essential Oil Grade',
    appearance: 'Colorless to pale yellow liquid',
    odor: 'Fresh, herbaceous, camphoraceous',
    meltingPoint: 'N/A (liquid)',
    boilingPoint: '150–200 °C (fraction range)',
    density: '0.875–0.920 g/cm³',
    solubility: 'Insoluble in water; miscible with ethanol, oils',
    applications: [
